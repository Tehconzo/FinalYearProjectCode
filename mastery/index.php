...
if(isset($_GET['mastery'])){
  $split_mastery = preg_split('/,/',$_GET['mastery']);
}
...
<div class="col-lg-12 col-sm-12">
    <div class="card hovercard">
        ...
        <div class="card-info">
        <span class="card-title"><a "<?php echo '../search/?region_val='.$region.'&name='.$summoner_name; ?>"> <?php echo $summoner_name; ?></a></span>
    ...
    <?php
                                  ...
                                  foreach ($split_mastery as $key => $value) {

                    $mastery_url = 'https://'.$reg.'.api.pvp.net/api/lol/static-data/'.$region.'/v1.2/mastery/'.$value.'?api_key=RGAPI-5ca97456-2013-4eeb-9ce9-d4ecc87ae71e';
                    if(@file_get_contents($mastery_url)){
                        $json = file_get_contents($mastery_url);
                      $array = json_decode($json, true);
                      if(isset($array['status'])){
                        echo "Mastery not found!";
                      }else{
                        ?>
            <tr>
                ...
                <td>
                  <?php 
                  foreach ($array['description'] as $key => $value) {
                       echo $value."<br>";
                   } 
                  ?></td>
